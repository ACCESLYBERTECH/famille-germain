    ...
    <div>
      ...
      <div className="flex gap-2 mb-0">
        <button
          ...
          className={ongletClass(onglet === 'attente')}
          style={onglet === 'attente' ? { backgroundColor: '#C9A84C' } : { backgroundColor: '#E0E0E0' }}
        >
          En attente
        ...
        <button
          ...
          className={ongletClass(onglet === 'actifs')}
          style={onglet === 'actifs' ? { backgroundColor: '#C9A84C' } : { backgroundColor: '#E0E0E0' }}
        >
          ...
          <div>
            {pciEnAttente.length === 0 ? (
              ...
              pciEnAttente.map(pci => (
                <div key={pci.id} className="p-4 border-b flex items-start justify-between gap-4"
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => approuver(pci.id)}
                      disabled={chargement === pci.id}
