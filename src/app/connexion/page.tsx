      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input type="email" value={courriel} onChange={e => setCourriel(e.target.value)} className="w-full border rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2" style={{ borderColor: '#E0E0E0' }} placeholder="votre@courriel.com" />
          </div>

          <div>
            <div className="flex justify-between items-center mb-1">
              <label className="block text-sm font-medium" style={{ color: '#1A2535' }}>Mot de passe</label>
              <a href="/mot-de-passe-oublie" className="text-xs hover:underline" style={{ color: '#2E86C1' }}>
                Mot de passe oublié?
              </a>
            </div>
